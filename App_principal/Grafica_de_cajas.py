...
st.page_link("Histograma.py", label = "Siguiente página")  # El nombre del archivo de la siguiente página

st.page_link("Grafica_de_dispersion.py", label = "Página anterior")