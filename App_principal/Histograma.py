...
st.page_link("Grafica_de_barras.py", label = "Siguiente página")  # El nombre del archivo de la siguiente página

st.page_link("Grafica_de_cajas.py", label = "Página anterior")